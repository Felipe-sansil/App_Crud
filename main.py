...
class Application:
   def __init__(self, master=None):
          ...
          text="ID Usuario:", font=self.fonte, width=10)
          ...
          self.btnVisualizar = Button(self.container8, text="Visualizar Usuários", font=self.fonte, width=20)
          self.btnVisualizar["command"] = self.visualizarUsuarios
          self.btnVisualizar.pack(side=LEFT)
   ...
   def visualizarUsuarios(self):
     ...
     # Criar uma nova janela para exibir a lista de usuários
          window = Toplevel(self.container8)
          ...
          lista_usuarios = user.selectAllUsers()

               # Criar um frame e adicionar uma Treeview para exibir os usuários
          frame = Frame(window)
          frame.pack()

          tree = ttk.Treeview(frame, columns=("ID", "Nome", "Telefone", "Email", "Usuário", "Senha"), show="headings")

               # Configurar as colunas
          for col in ("ID", "Nome", "Telefone", "Email", "Usuário", "Senha"):
                    tree.heading(col, text=col)
                    tree.column(col, width=200, anchor='w')
                    
                    #campo id
                    tree.heading("ID", text="ID")
                    tree.column("ID", width=40, anchor='w')
                    ...
                    tree.column("Telefone", width=150, anchor='w')
          ...
          for usuario in lista_usuarios:
                    tree.insert("", index="end", values=usuario.split(", "))
